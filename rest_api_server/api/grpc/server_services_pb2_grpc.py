...
from . import server_services_pb2 as server__services__pb2
...
class SendFileServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CsvToXml = channel.unary_unary(
                '/server_services.SendFileService/CsvToXml',
        ...
        self.FilterXml = channel.unary_unary(
                ...
                request_serializer=server__services__pb2.FilterXmlRequest.SerializeToString,
                response_deserializer=server__services__pb2.FilterXmlResponse.FromString,
                _registered_method=True)
...
def add_SendFileServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'FilterXml': grpc.unary_unary_rpc_method_handler(
                    servicer.FilterXml,
                    request_deserializer=server__services__pb2.FilterXmlRequest.FromString,
                    response_serializer=server__services__pb2.FilterXmlResponse.SerializeToString,
            ),
    }
...
class SendFileService(object):
    ...
    def FilterXml(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/server_services.SendFileService/FilterXml',
            server__services__pb2.FilterXmlRequest.SerializeToString,
            server__services__pb2.FilterXmlResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
